...
Verified against the following test ROM suites:

- **Blargg's tests** — instruction timing: ✅ Pass
- **Mooneye Test Suite**:
  - `div_write`: ✅ Pass
  - Rapid toggle: ✅ Pass

More test suites (Blargg's CPU instructions, Mooneye's other categories,
acid2, etc.) may be added here as they're run.
